...
/** @hide */
	...
	public BluetoothChatFragment_ChatHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == BluetoothChatFragment_ChatHandler.class)
			mono.android.TypeManager.Activate ("SATCARGO.BluetoothChatFragment+ChatHandler, SATCARGO", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public BluetoothChatFragment_ChatHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == BluetoothChatFragment_ChatHandler.class)
			mono.android.TypeManager.Activate ("SATCARGO.BluetoothChatFragment+ChatHandler, SATCARGO", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
