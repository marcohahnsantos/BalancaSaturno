...
public class ActCadastroVeiculos
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SATCARGO.Activitys.ActCadastroVeiculos, SATCARGO", ActCadastroVeiculos.class, __md_methods);
	}


	public ActCadastroVeiculos ()
	{
		super ();
		if (getClass () == ActCadastroVeiculos.class)
			mono.android.TypeManager.Activate ("SATCARGO.Activitys.ActCadastroVeiculos, SATCARGO", "", this, new java.lang.Object[] {  });
	}
