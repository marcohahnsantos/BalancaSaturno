...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SATCARGO.ClassesGerais.Mask, SATCARGO", Mask.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Mask.class)
			mono.android.TypeManager.Activate ("SATCARGO.ClassesGerais.Mask, SATCARGO", "", this, new java.lang.Object[] {  });
	}

	public Mask (android.widget.EditText p0, java.lang.String p1)
	{
		super ();
		if (getClass () == Mask.class)
			mono.android.TypeManager.Activate ("SATCARGO.ClassesGerais.Mask, SATCARGO", "Android.Widget.EditText, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
