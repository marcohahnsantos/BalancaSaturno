...
namespace com.xamarin.samples.bluetooth.bluetoothchat
{
    ...
    public class DeviceListActivity : Activity
    {
        ...
        public void StartScan()
        {
            ...
            var b = BluetoothDevice.ActionFound;
        ...
        void DeviceListView_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            var intent = new Intent(this, typeof(ActConfiguraComunicacao));
            if (Validacoes.DeviceListPrinter==true)
              intent = new Intent(this,typeof(ActConfiguraPrinter));
            //intent.PutExtra(EXTRA_DEVICE_ADDRESS, address);
//            Intent i = new Intent(Activity.this, NewActivity.class);
            SetResult(Result.Ok, intent);
            intent.PutExtra("nome", device[0].ToString());
